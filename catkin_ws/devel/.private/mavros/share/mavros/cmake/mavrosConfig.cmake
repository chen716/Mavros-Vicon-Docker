...
if("TRUE" STREQUAL "TRUE")
  set(mavros_SOURCE_PREFIX /root/catkin_ws/src/mavros/mavros)
  set(mavros_DEVEL_PREFIX /root/catkin_ws/devel/.private/mavros)
  set(mavros_INSTALL_PREFIX "")
  set(mavros_PREFIX ${mavros_DEVEL_PREFIX})
else()
  set(mavros_SOURCE_PREFIX "")
  set(mavros_DEVEL_PREFIX "")
  set(mavros_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT "/root/catkin_ws/src/mavros/mavros/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(mavros_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_ws/src/mavros/mavros/include;/usr/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mavros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/mavros/mavros/${idir}'.  ${_report}")
    endif()
    _list_append_unique(mavros_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "mavros;/usr/lib/aarch64-linux-gnu/libboost_system.so.1.71.0;/usr/lib/aarch64-linux-gnu/libGeographic.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/mavros/lib;/root/catkin_ws/devel/lib;/opt/ros/noetic/lib)
