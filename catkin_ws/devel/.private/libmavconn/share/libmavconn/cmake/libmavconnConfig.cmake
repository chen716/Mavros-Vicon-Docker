...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /root/catkin_ws/src/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /root/catkin_ws/devel/.private/libmavconn)
  ...
  set(libmavconn_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT "/root/catkin_ws/src/mavros/libmavconn/include;/usr/include;/root/catkin_ws/devel/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_ws/src/mavros/libmavconn/include;/usr/include;/root/catkin_ws/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/mavros/libmavconn/${idir}'.  ${_report}")
    endif()
    _list_append_unique(libmavconn_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "mavconn;/usr/lib/aarch64-linux-gnu/libboost_system.so.1.71.0;/usr/lib/aarch64-linux-gnu/libconsole_bridge.so.0.4")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/libmavconn/lib;/root/catkin_ws/devel/lib;/opt/ros/noetic/lib)
